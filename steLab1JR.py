...
class Testcplxop(unittest.TestCase):
    ...
    def test_restcplx(self): #error tupla
        self.assertAlmostEqual(lc.restcplx ((3.1,2.4),(5.6,1.2)),(8.7,1.2))
        self.assertAlmostEqual(lc.restcplx((11.2,20), (5.1,15)), (6.1,5))
    ...
    def test_divcplx(self):
        ...
        self.assertAlmostEqual(lc.divcplx(45, 105), (5, 11), (9, 0.202))
